...
class TestDot20(unittest.TestCase):
    def __init__(self, methodName: str = "runTest") -> None:
        self.dot20 = Dot20(
            db_url="mysql+pymysql://root:12345678@localhost:3306/wjy")
    ...
    def test_deploy(self):
        try:
            ...
            deploy_json = {
                ...
                "memo": "{\"p\": \"dot-20\", \"op\": \"deploy\",\"mode\": \"owner\", \"tick\": \"dota\",\"decimal\": 12, \"start\": 273115, \"max\": 1000000000000000000000, \"lim\": 1000000000000000, \"amt\": 1000000000000, \"end\": 123444, \"admin\": \"15Dfr41oVWMhqKD6qL1pj6gZEE6vzNQ9RH8ShefFsoReVWsi\"}"
            }
