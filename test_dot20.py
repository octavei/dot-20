...
class TestDot20(unittest.TestCase):
    def __init__(self, methodName: str = "runTest") -> None:
        self.dot20 = Dot20(
            db_url="mysql+mysqlconnector://root:123456@localhost:3306/wjy")
    ...
    def test_deploy(self):
        try:
            ...
            deploy_json = {
                ...
                "memo": "{\"p\": \"dot-20\", \"op\": \"deploy\",\"mode\": \"fair\", \"tick\": \"dota\",\"decimal\": 18, \"start\": 273115, \"max\": 10000000000, \"lim\": 1000000, \"amt\": 1000, \"end\": 283115, \"admin\": \"15Dfr41oVWMhqKD6qL1pj6gZEE6vzNQ9RH8ShefFsoReVWsi\"}"
            }
